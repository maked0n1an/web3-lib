...
async def main():
    ...
    usdc_token = Web3.to_checksum_address('0xaf88d065e77c8cC2239327C5EDb3A432268e5831')
    
    eth_amount = 0.0005
    min_amount = eth_amount * await get_min_to_amount(from_token='ETH', to_token='USDC')
